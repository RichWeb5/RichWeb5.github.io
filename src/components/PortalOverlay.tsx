        ...
        <AnimatePresence>
            {!clicked && (
                ...
                >
                    ...
                    >
                        <p className="title font-pixel text-lg">{t('portal.title')}</p>
                        ...
                        <p className="mb-4 font-pixel text-center">
                            {t('portal.intro.before')}<span className="text-green-700">{siteConfig.profile.name}</span>{t('portal.intro.after')}
                        </p>
